...
zstyle ':fzf-tab:complete:(cd|ls):*' fzf-preview 'exa -1 --color=always $realpath'
...
alias upgrade_nvim='cd $NVIM && upgrade_repo; cd - >/dev/null'
alias upgrade_nvimc='cd $NVIMC && upgrade_repo; cd - >/dev/null'
